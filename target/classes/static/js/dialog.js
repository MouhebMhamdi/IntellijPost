...
class Dialog {
    ...
    assemblyButtons() {
        switch (this.option.buttons) {
            ...
            case Dialog.buttons.yes:
                new DialogButton(this, Dialog.button.YES).assembly().focus();
    ...
    initEvents() {
        ...
        // prevent esc
        this.dialog.addEventListener('Annuler', (e) => { 
     ...
     * START static helper
     */
    static alert(message, caption = 'Erreur !') {
        return new Dialog({
            caption: `${caption}`,
            content:' <center><i class="glyphicon glyphicon-exclamation-sign fa-3x text-secondary"></i></center><div class="text-center">'+message+'</div>',
